...
\usepackage{subscript} %superÃ­ndexs i subÃ­ndexs
\setcounter{secnumdepth}{5} %Numerar fins a subparÃ grafs
...
\newcommand{\seny}{senyalitzaciÃ³}
\newcommand{\aas}{aminoÃ cids}
\newcommand{\TF}{factor de transcripciÃ³}
\newcommand{\TFs}{factors de transcripciÃ³}
\newcommand{\tgfb}{TGF\textgreek{b}}
\newcommand{\pparg}{PPAR\textgreek{g}}
\newcommand{\betaadren}{\textgreek{b}-adrenÃšrgic}
...
% EncapÃ§alament i peu de pÃ gina
\usepackage{fancyhdr}
\pagestyle{fancy}
%\renewcommand{\sectionmark}[1]{\markright{\textsc{\thesection. #1}}}
\lhead{}
\rhead{}
\lfoot{\sc Enginyeria Gen?tica}
%\rfoot{\thepage}
\cfoot{}
...
\newtcbtheorem[number within=section]{dades}{AnÃ lisi de dades} {colback=colordadesfons,colframe=colordadesmarc,fonttitle=\bfseries,separator sign={\ $\blacktriangleright$}}{theo}
...
\newtcbtheorem[number within=section]{metodes}{MÃštodes} {colback=red!5!white,colframe=red!75!black,fonttitle=\bfseries,separator sign={\ $\blacktriangleright$}}{theo}
...
\HRule \\[0.4cm]
{\Huge\bfseries\textsc{Enginyeria Gen�tica}} \\[0.4cm] % Title of your document
\HRule \\[04cm]
...
%Cos dels apunts 
%------------------------------------------------------------------------------
\pagenumbering{Roman} % para comenzar la numeraciÃ³n de paginas en nÃºmeros romanos
...
%--------------------------------------------------------------------------------------------------
%BLOC 1. MANEIG D'?CIDS NUCLEICS
%--------------------------------------------------------------------------------------------------
\newpage
\pagenumbering{arabic}
\part{Maneig d'�cids nucleics}

%--------------------------------------------------------
% Tema 1. PreparacioÌ i anaÌlisi dels aÌcids nucleics
%--------------------------------------------------------
...
%--------------------------------------------------------------------------------------------------
%BLOC 3. CARACTERITZACIÃ DELS PRODUCTES D'EXPRESSIÃ
%--------------------------------------------------------------------------------------------------
\newpage
\part{Caracteritzaci� d'�cids nucleics}


%--------------------------------------------------------------------------------------------------
%BLOC 4. APLICACIONS DE L'ENGINYERIA GENÃTICA 
%--------------------------------------------------------------------------------------------------
\newpage
\pagenumbering{arabic}
\part{Aplicacions de l'enginyeria gen�tica}
...
\newpage
\phantomsection
\addcontentsline{toc}{part}{ReferÃšncies}
\begin{multicols}{2}
