...
% Encap√ßalament i peu de p√†gina
\usepackage{fancyhdr}
\pagestyle{fancy}
%\renewcommand{\sectionmark}[1]{\markright{\textsc{\thesection. #1}}}
\lhead{}
\rhead{}
\lfoot{\sc Enginyeria GenËtica}
%\rfoot{\thepage}
\cfoot{}
...
\HRule \\[0.4cm]
{\Huge\bfseries\textsc{Enginyeria GenËtica}} \\[0.4cm] % Title of your document
\HRule \\[04cm]
\includegraphics[width=1\textwidth]{Logo} %Include a department/university logo

\vspace{1cm}
\textsc{\Large CiËncies BiomËdiques UB - Primavera 2017}\\[0.5cm] % Minor heading such as course title
\vspace{0.5cm}
\textsc{\large Albert TorellÛ PÈrez}
...
%-------------------------------------------------------------------------------
\newpage
\part{CaracteritzaciÛ d'‡cids nucleics}
...
%--------------------------------------------------------------------------------------------------
\newpage
\part{Aplicacions de l'enginyeria genËtica}
