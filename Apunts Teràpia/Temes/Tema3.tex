%------------------------------------------------------------------------------
% Tema 3. Teràpia cel·lular per malalties coronàries
%------------------------------------------------------------------------------
\section{Teràpia cel·lular per malalties coronàries}

\subsection{Infart de miocardi}
...
\subsection{Estratègies de teràpia}
...
\begin{figure}[H]
  ...
  \caption{Seccions del ventricle d'una rata adulta}
  \label{fig:fig10}
\end{figure}

\subsubsection{Ús de cèl·lules de cor}
...
\begin{figure}[H]
  ...
  \caption{Anàlisi clonal de cardiomiòcits}
  \label{fig:fig11}
\end{figure}

\subsubsection{Ús de HSC}
Es provoca una isquèmia en rates femella. Per altra banda, hi ha mascles que expressen GFP i se'ls fa una punció ilíaca. Es van barrejar les cèl·lules obtingudes amb un hidrogel. Els hidrogels s'obtenen de matriu extracel·lular de sarcomes en cultiu.

\begin{figure}[H]
  \centering
    \includegraphics[width=0.85\textwidth]{fig12}
  \caption{Injecció de MSC en un cor infartat}
  \label{fig:12}
\end{figure}
