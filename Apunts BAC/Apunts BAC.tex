...
\lhead{}
\rhead{}
\lfoot{\sc Bioquímica Analítica i Clínica}
%\rfoot{\thepage}
\cfoot{}
...
\HRule \\[0.4cm]
{\Huge\bfseries\textsc{Bioquímica Analítica i Clínica}} \\[0.4cm] % Title of your document
\HRule \\[04cm]
...
%Cos dels apunts 
%------------------------------------------------------------------------------
\pagenumbering{Roman} % para comenzar la numeración de paginas en
                      % números romanos 
...
\end{document}
El final és 60 preguntes tipus test, 3 preguntes curtes de cada part +
10 preguntes de pràctiques.

Treball: Vicent Casadó